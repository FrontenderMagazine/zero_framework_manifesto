...
Javascript фреймворки подобно смерти и налогам, неминуемы и неизбежны. Я
уверен, что если бы я мог быть мухой на той стене, где каждый раз, когда кто-то
начинает новый веб-проект, то самый первый вопрос, который они бы задали это,
...
что то вроде JQuery и Dojo и MochiKit и ExtJS и AngularJS и Backbone и Ember и
...
фреймворком. На самом деле это градиент кода, который начинается с простого
